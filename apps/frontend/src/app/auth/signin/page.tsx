...
export default function SignInPage() {
  ...
  const handleFlipToRegister = (e: FormEvent<HTMLButtonElement>) => {
    e.preventDefault();
    setIsFlipped(true);
  };

  const handleFlipToLogin = (e: FormEvent<HTMLButtonElement>) => {
    e.preventDefault();
    setIsFlipped(false);
  };
  ...
  const handleLogin = (e: FormEvent<HTMLFormElement>) => {
    ...
    setTimeout(() => {
      ...
      localStorage.setItem('pharmacie_user', JSON.stringify({
      ...
      <div className="wrap">
        ...
        <div className="right">
          <div className="scene">
            ...
            >
              {/* Front Face - Login */}
              <div className="face front-face" ref={frontRef}>
              ...
              {/* Back Face - Register */}
              <div className="face back-face" ref={backRef}>
